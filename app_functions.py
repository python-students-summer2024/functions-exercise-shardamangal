...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        question = question = "You rolled a {} and a {}... What is the sum of {} and {}?".format(die_1_value, die_2_value, die_1_value, die_2_value)
    else:
        question = "You rolled a {} and a {}... What is the difference between {} and {}?".format(die_1_value, die_2_value, die_1_value, die_2_value)
...
def print_congratulations(question_type):
    ...
    # complete this function below here
    if question_type == "sum":
        message = "Yes! Congratulations on the successful addition!"
    elif question_type == "difference":
        message = "Yes! Congratulations on the successful subtraction!"
    print(message)
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        correct_answer = die_1_value + die_2_value
        message = "No! The sum of {} and {} is {}!".format(die_1_value, die_2_value, correct_answer)
    elif question_type == "difference":
        correct_answer = abs(die_1_value - die_2_value)
        message = "No! The difference between {} and {} is {}!".format(die_1_value, die_2_value, correct_answer)
